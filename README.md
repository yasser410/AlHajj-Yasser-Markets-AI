...
> يُوقَّع ملف الإصدار الحالي بشهادة اختبار Android لضمان إمكانية تثبيته مباشرة من GitHub. قبل نشره على متجر عام، يجب استبدالها بمفتاح توقيع إنتاجي خاص محفوظ بأمان.
